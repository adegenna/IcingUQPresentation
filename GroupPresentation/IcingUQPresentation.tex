...
\begin{columns}[c]
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[Laplacian]{\includegraphics[width=0.95\textwidth]{DistanceMatrixOrdered.png}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{LaplacianUnconnectedCluster}}
      \caption{$\lambda = 0$}
    \end{figure}    
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[Laplacian]{\includegraphics[width=0.95\textwidth]{DistanceMatrixOrdered.png}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{FiedlerVectorGrouping}}
      \caption{Fiedler Vector}
    \end{figure}
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[Laplacian]{\includegraphics[width=0.95\textwidth]{DistanceMatrixOrdered2.png}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{Fiedler2VectorGrouping}}
...
\begin{columns}[c]
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[POD coordinates]{\includegraphics[width=0.95\textwidth]{ClusterPODcoords}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{LaplacianUnconnectedCluster}}
      \caption{$\lambda = 0$}
    \end{figure}    
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[POD coordinates]{\includegraphics[width=0.95\textwidth]{FiedlerVectorPODcoords}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{FiedlerVectorGrouping}}
      \caption{Fiedler Vector}
    \end{figure}
  \column{0.3\textwidth}
    \centering
    \vspace*{-0.0cm}\begin{figure}
      \subfigure[POD coordinates]{\includegraphics[width=0.95\textwidth]{Fiedler2VectorPODcoords}}
      \subfigure[Ice shapes]{\includegraphics[width=0.95\textwidth]{Fiedler2VectorGrouping}}
      \caption{Next eigenvector}
    \end{figure}
\end{columns}

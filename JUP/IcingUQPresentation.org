...
*Approach:*
  ...
  - Generate random ice shapes corresponding to given conditions
    - Filter database based on temperature, LWC, time
    - Generate random samples that match POD coefficient statistics
    - Construct corresponding ice shapes
...
** POD Reconstructions
\begin{figure}
      \vspace*{-0.9cm}\subfigure{\includegraphics[width=0.35\textwidth]{UnfilteredReconstructionEx2.png}}
      \vspace*{-0.9cm}\subfigure{\includegraphics[width=0.35\textwidth]{FilteredReconstructionEx2.png}} \\
      \vspace*{-0.5cm}\subfigure{\includegraphics[width=0.35\textwidth]{UnfilteredReconstructionEx3.png}}
      \vspace*{-0.5cm}\subfigure{\includegraphics[width=0.35\textwidth]{FilteredReconstructionEx3.png}} \\
      \vspace*{-0.5cm}\subfigure{\includegraphics[width=0.35\textwidth]{UnfilteredReconstructionEx1.png}}
      \vspace*{-0.5cm}\subfigure{\includegraphics[width=0.35\textwidth]{FilteredReconstructionEx1.png}}
      \vspace*{0cm}\caption{POD reconstructions.}
\end{figure}

** Link Physical Conditions to Modes
\begin{figure}
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode1Mode2Time}}
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode3Mode4Time}} \\
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode1Mode2Temp}}
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode3Mode4Temp}} \\
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode1Mode2LWC}}
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamMode3Mode4LWC}}
...
\begin{figure}
      ...
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamRandomHorns}}
      \vspace*{-0.4cm}\subfigure{\includegraphics[width=0.4\textwidth]{10ParamRandomRime}}
